                                    ...
                                    <div class="row p-5 border-bottom">
                                        <div class="col-sm-12 col-md-12 col-xl-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input id="project-name" type="text" class="form-control text-dark" placeholder="CMAM">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-xl-3">
                                            <div class="form-group">
                                                ...
                                                <div id="ps-datepicker" class="input-group date" data-date-format="dd-mm-yyyy">
                                                    ...
                                                    <input id="project-start-date" class="form-control" type="text" placeholder="Selecione a data"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-xl-3 end-date-container">
                                            <div class="form-group">
                                                ...
                                                <div id="pe-datepicker" class="input-group date" data-date-format="dd-mm-yyyy">
                                                    <span class="input-group-addon input-group-text bg-primary-transparent"><i class="fe fe-calendar text-primary-dark"></i></span>
                                                    <input id="project-end-date" class="form-control" type="text" placeholder="Selecione a data"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12 col-md-12 col-xl-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2-show-search" id="project-category" data-placeholder="Escolhe o tipo...">
                                        ...
                                        <div class="col-sm-12 col-md-12 col-xl-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2-show-search" id="project-department" data-placeholder="Escolhe o tipo...">
                                                    <option label="Choose one"></option>
                                        ...
                                        <div class="col-sm-12 col-md-12 col-xl-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2-client-search" data-placeholder="Escolha os clientes">
                                        ...
                                        <div class="col-sm-12 col-md-12 col-xl-6">
                                            ...
                                            <div class="form-group">
                                                <div id="summernote2"><p>verificar o protocolo SSL</p></div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row other-details-main d-none mt-4">
                                                ...
                                                <div class="col-sm-12 col-md-12 col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="e.x. 1000" min="0">
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-12 col-xl-4">
                                                    <div class="form-group">
                                                        <label class="form-label text-muted">Horas estimadas:</label>
                                                        <input type="number" class="form-control" placeholder="e.x. 700" min="0">
                                                    </div>
                                                </div>
