                            ...
                            <ul class="slide-menu">
                                ...
                                <li class="sub-slide">
                                    <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
                                            ...
                                            class="sub-angle fa fa-angle-right"></i></a>
                                    <ul class="sub-slide-menu">
                                        <li><a class="sub-slide-item" href="#">Projetos</a></li>
                                        <li><a class="sub-slide-item" href="#">Lista de projetos</a></li>
                                        <li><a class="sub-slide-item" href="#">Detalhes do Projeto</a></li>
                                        <li><a class="sub-slide-item" href="#">Criar Novo Projeto</a></li>
                                        <li><a class="sub-slide-item" href="#">Editar Projeto</a></li>
                                    </ul>
                                </li>
