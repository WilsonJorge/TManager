                    ...
                    <div class="page-header">
                        ...
                        <div class="ms-auto pageheader-btn">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Projeto</a></li>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div  class="card">
                                <div class="card-header border-bottom">
                                    <h4 class="mb-0">Detalhes do Projeto</h4>
                                </div>
                                <div class="card-body p-0 create-project-main">
                                    <div class="row p-5 border-bottom">
                                        <div class="col-sm-12 col-md-12 col-xl-3">
                                            <div class="form-group">
                                                <label for="project-name" class="form-label text-muted">Nome do Projeto</label>
                                                <div class="input-group">
                                                    <input id="project-name" name="nome" type="text" class="form-control text-dark" placeholder="CMAM">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-xl-3">
                                            <div class="form-group">
                                                <label for="project-start-date" class="form-label text-muted">Data do Inicio do Projeto:</label>
                                                <div id="ps-datepicker" class="input-group date" data-date-format="dd-mm-yyyy">
                                                    ...
                                                    <input id="project-start-date" name="dataInicio" class="form-control" type="text" placeholder="Selecione a data"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-xl-3 end-date-container">
                                            <div class="form-group">
                                                <label for="project-end-date" class="form-label text-muted">Data do Termino do Projeto:</label>
                                                <div id="pe-datepicker" class="input-group date" data-date-format="dd-mm-yyyy">
                                                    <span class="input-group-addon input-group-text bg-primary-transparent"><i class="fe fe-calendar text-primary-dark"></i></span>
                                                    <input id="project-end-date" name="dataFim " class="form-control" type="text" placeholder="Selecione a data"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-xl-3 no-date-checkbox">
                                            <div class="form-group">
                                                <label class="custom-control custom-checkbox end-date-checkbox-container">
                                                    <input type="checkbox"  name="semData" class="custom-control-input end-date-checkbox" value="option2">
                                                    <span class="custom-control-label">Sem data de Termino.</span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-xl-4">
                                            <div class="form-group">
                                                <label for="project-category" class="form-label text-muted">Categoria do Projecto:</label>
                                                <select class="form-control select2-show-search" id="project-category" name="categoria" data-placeholder="Escolhe o tipo...">
                                                    <option label="Choose one"></option>
                                                    <option value="vazio" selected>---</option>
                                                    <option value="publio">Publico</option>
                                        ...
                                        <div class="col-sm-12 col-md-12 col-xl-4">
                                            <div class="form-group">
                                                <label for="project-department" class="form-label text-muted">Departamento:</label>
                                                <select class="form-control select2-show-search" id="project-department" name="departamento" data-placeholder="Escolhe o tipo...">
                                                    <option label="Choose one"></option>
                                        ...
                                        <div class="col-sm-12 col-md-12 col-xl-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2-client-search" name="cliente" data-placeholder="Escolha os clientes">
                                                    <option value="1">UGPK</option>
                                                    <option value="2">CMAM</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-xl-6">
                                            <label class="form-label text-muted">Resumo do projeto: </label>
                                            <div class="form-group">
                                                <div id="summernote" name="resumo " ><p></p></div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-xl-6">
                                            <label class="form-label text-muted">Notas Projecto: </label>
                                            <div class="form-group">
                                                <div id="summernote2" name="notasResumo"><p>verificar o protocolo SSL</p></div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <ul>
                                                    <li class="select-client">
                                                        <select class="form-control select2-client-search" name="atribuido" multiple>
                                                            <option value="1">Ivan Patel</option>
                                                            <option value="2">Ernesto Nhambe</option>
                                                        </select>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="row p-5 border-bottom">
                                        <div class="col-xl-12">
                                            <h6 class="mb-0 d-flex other-details">Outros Detalhes<i class="fe fe-chevron-down down-arrow fs-15"></i><i class="fe fe-chevron-up up-arrow d-none fs-15"></i></h6>
                                            <div class="row other-details-main d-none mt-4">
                                                <div class="col-sm-12 col-md-12 col-xl-12">
                                                    <label class="form-label text-muted">Adicionar arquivos:</label>
                                                    <div class="form-group">
                                                        <form method="post">
                                                            <input type="file" class="dropify" name="arquivos" data-bs-height="100" />
                                                        </form>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-12 col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <select class="form-control select2-show-search" id="currency-type" name="moeda" data-placeholder="Choose Type...">
                                                                <option label="Choose one"></option>
                                                ...
                                                <div class="col-sm-12 col-md-12 col-xl-4">
                                                    <div class="form-group">
                                                        <label class="form-label text-muted">Orçamento:</label>
                                                        <input type="number" class="form-control" name="orcamento" placeholder="e.x. 1000" min="0">
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-12 col-xl-4">
                                                    <div class="form-group">
                                                        <label class="form-label text-muted">Horas estimadas:</label>
                                                        <input type="number" class="form-control" name="horas" placeholder="e.x. 700" min="0">
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-12 col-xl-4 mt-2">
                                                    <div class="form-group">
                                                        <label class="custom-control custom-checkbox">
                                                            ...
                                                            <span class="custom-control-label">Registros de tempo manuais.</span>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-12 col-xl-4 mt-2">
                                                    <div class="form-group">
                                                        <label class="custom-control custom-checkbox client-checkbox-container">
                                                            ...
                                                            <span class="custom-control-label">O cliente pode gerenciar tarefas deste projeto.</span>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-12 col-xl-4 mt-2 d-none notifications-container">
                                                    <div class="form-group">
                                                        <label class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input">
                                                            <span class="custom-control-label">Notificações de tarefas para o cliente.</span>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
