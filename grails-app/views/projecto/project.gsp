                            ...
                            <ul class="slide-menu">
                                ...
                                <li class="sub-slide">
                                    ...
                                    <ul class="sub-slide-menu">
                                        ...
                                        <g:link controller="tarefa" action="edit" class="sub-slide-item">Editar Tarefa</g:link>
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body project-type-container projects p-4">
                                            <h4 class="m-0" id="typeTitle">Todos Projetos</h4>
                                            <div class="d-sm-flex align-items-center">
                                                <div class="btn-list mx-4">
                                                    ...
                                                    <g:link class="btn btn-outline-primary" controller="projecto" action="index">
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col">
                                                                        <div class="d-sm-flex align-items-center">
                                                                            ...
                                                                            <div class="ms-1">
                                                                                <h6 class="mb-1"> <a href="#" class="float-start">CMAM</a> <span class="text-muted bg-light fs-11 mx-2">abriu ontem</span> </h6>
                                                                                <span class="text-muted border-end pe-2 fs-11 float-start mt-1">28 tarefas</span>
                                                                                <span class="text-teritary ps-1 fs-11">11 Nov 23</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-auto">
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-start">
                                                                                <a class="dropdown-item" href="#"><i class="fe fe-edit me-2"></i> Editar</a>
                                                                                <a class="dropdown-item" href="#"><i class="fe fe-trash me-2"></i> Apagar</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-md-12 mt-4">
                                                                <div class="row align-items-center">
                                                                    ...
                                                                    <div class="col-auto">
                                                                        <p class="mb-0">
                                                                            <span class="text-muted d-block">Data de vencimento</span>
                                                                            <span class="text-danger">11 Nov 23</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col">
                                                                        <div class="d-sm-flex align-items-center">
                                                                            ...
                                                                            <div class="ms-1">
                                                                                <h6 class="mb-1 text-normal"> <a class="float-start">MTC</a> <span class="text-muted bg-light fs-11  mx-2">aberto há 1 minuto</span> </h6>
                                                                                <span class="text-muted border-end pe-2 fs-11 float-start mt-1">58 tarefas</span>
                                                                                <span class="text-teritary ps-1 fs-11">16 Abr 23</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-auto">
                                                                ...
                                                                <div class="row align-items-center">
                                                                    <div class="col">
                                                                        ...
                                                                        <div class="avatar-list">
                                                                            <span class="avatar bradius bg-primary">+10</span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-auto">
                                                                        <p class="mb-0">
                                                                            <span class="text-muted d-block">Data de vencimento</span>
                                                                            <span class="text-danger">30 Oct 23</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col">
                                                                        <div class="d-sm-flex align-items-center">
                                                                            ...
                                                                            <div class="ms-1">
                                                                                <h6 class="mb-1 text-normal"> <a  class="float-start">UGPK</a> <span class="text-muted bg-light fs-11 mx-2">inaugurado há 1 mês</span> </h6>
                                                                                <span class="text-muted border-end pe-2 fs-11 float-start mt-1">5 tarefas</span>
                                                                                <span class="text-teritary ps-1 fs-11">29 Apr 23</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-auto">
                                                            ...
                                                            <div class="col-md-12 mt-4">
                                                                <div class="row align-items-center">
                                                                    ...
                                                                    <div class="col-auto">
                                                                        <p class="mb-0">
                                                                            <span class="text-muted d-block">Data de vencimento</span>
                                                                            <span class="text-danger">14 Dec 23</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col">
                                                                        <div class="d-sm-flex align-items-center">
                                                                            ...
                                                                            <div class="ms-1">
                                                                                <h6 class="mb-1 text-normal"> <a class="float-start">GIT</a> <span class="text-muted bg-light fs-11 mx-2">inaugurado há 1 mês</span> </h6>
                                                                                <span class="text-muted border-end pe-2 fs-11 float-start mt-1">16 tarefas</span>
                                                                                <span class="text-teritary ps-1 fs-11">11 Nov 23</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-12 mt-4">
                                                                <div class="row align-items-center">
                                                                    ...
                                                                    <div class="col-auto">
                                                                        <p class="mb-0">
                                                                            <span class="text-muted d-block">Data de vencimento</span>
                                                                            <span class="text-danger">16 Jan 23</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                %{--<div class="row">--}%
                                                                    %{--<div class="col">--}%
                                                                        %{--<div class="d-sm-flex align-items-center">--}%
                                                                            ...
                                                                            %{--</div>--}%
                                                                            %{--<div class="ms-2">--}%
                                                                                %{--<h6 class="mb-1 text-normal"> <a href="project-details.html" class="float-start">SEO Using React</a> <span class="text-muted bg-light fs-11 mx-2">opened 4mth ago</span> </h6>--}%
                                                                ...
                                                                %{--<div class="row align-items-center">--}%
                                                                    %{--<div class="col">--}%
                                                                        ...
                                                                        %{--<div class="avatar-list avatar-list-stacked">--}%
                                                                            ...
                                                                            %{--<span class="avatar bradius cover-image" data-bs-image-src= "../assets/images/users/6.jpg"></span>--}%
                                                                            %{--<span class="avatar bradius bg-primary">+5</span>--}%
                                                                        %{--</div>--}%
                                                                    %{--</div>--}%
                                                                    %{--<div class="col-auto">--}%
                                                                ...
                                                                %{--<div class="row">--}%
                                                                    %{--<div class="col">--}%
                                                                        %{--<div class="d-sm-flex align-items-center">--}%
                                                                            ...
                                                                            %{--</div>--}%
                                                                            %{--<div class="ms-1">--}%
                                                                                %{--<h6 class="mb-1 text-normal"> <a href="project-details.html" class="float-start">Web Design</a> <span class="text-muted bg-light fs-11 mx-2">opened yesterday</span> </h6>--}%
                                                                ...
                                                                %{--<div class="row">--}%
                                                                    %{--<div class="col">--}%
                                                                        %{--<div class="d-sm-flex align-items-center">--}%
                                                                            ...
                                                                            %{--</div>--}%
                                                                            %{--<div class="ms-1">--}%
                                                                                %{--<h6 class="mb-1 text-normal"> <a href="project-details.html" class="float-start">System Design</a> <span class="text-muted bg-light fs-11 mx-2">opened 2d ago</span> </h6>--}%
                                                                ...
                                                                %{--<div class="row">--}%
                                                                    %{--<div class="col">--}%
                                                                        %{--<div class="d-sm-flex align-items-center">--}%
                                                                            ...
                                                                            %{--</div>--}%
                                                                            %{--<div class="ms-1">--}%
                                                                                %{--<h6 class="mb-1 text-normal"> <a href="project-details.html" class="float-start">Ethical Hacking</a> <span class="text-muted bg-light fs-11 mx-2">opened 3d ago</span> </h6>--}%
                                                                                %{--<span class="text-muted border-end pe-2 fs-11 float-start mt-1">75 tasks</span>--}%
                                                                ...
                                                                %{--<div class="row">--}%
                                                                    %{--<div class="col">--}%
                                                                        %{--<div class="d-sm-flex align-items-center">--}%
                                                                            ...
                                                                            %{--</div>--}%
                                                                            %{--<div class="ms-1">--}%
                                                                                %{--<h6 class="mb-1 text-normal"> <a href="project-details.html" class="float-start">System Design</a> <span class="text-muted bg-light fs-12 mx-2">opened 2d ago</span> </h6>--}%
                                                                                %{--<span class="text-muted border-end pe-2 fs-11 float-start mt-1">116 tasks</span>--}%
                                                                                %{--<span class="text-teritary ps-1 fs-11">11 Nov 21</span>--}%
                                                                            %{--</div>--}%
                                                                        %{--</div>--}%
                                                                ...
                                                                %{--<div class="row">--}%
                                                                    %{--<div class="col">--}%
                                                                        %{--<div class="d-sm-flex align-items-center">--}%
                                                                            ...
                                                                            %{--</div>--}%
                                                                            %{--<div class="ms-1">--}%
                                                                                %{--<h6 class="mb-1 text-normal"> <a href="project-details.html" class="float-start">Login Authentication</a> <span class="text-muted bg-light fs-11 mx-2">opened 1min ago</span> </h6>--}%
                                                                ...
                                                                %{--<div class="row">--}%
                                                                    %{--<div class="col">--}%
                                                                        %{--<div class="d-sm-flex align-items-center">--}%
                                                                            ...
                                                                            %{--</div>--}%
                                                                            %{--<div class="ms-1">--}%
                                                                                %{--<h6 class="mb-1 text-normal"> <a href="project-details.html" class="float-start">Cloud Computing</a> <span class="text-muted bg-light fs-11 mx-2">opened 1min ago</span> </h6>--}%
                                                                ...
                                                                %{--<div class="row">--}%
                                                                    %{--<div class="col">--}%
                                                                        %{--<div class="d-sm-flex align-items-center">--}%
                                                                            ...
                                                                            %{--</div>--}%
                                                                            %{--<div class="ms-1">--}%
                                                                                %{--<h6 class="mb-1 text-normal"> <a href="project-details.html" class="float-start">SQL</a> <span class="text-muted bg-light fs-11 mx-2">opened 1mth ago</span> </h6>--}%
...
%{--<!-- INVOICE CREATE JS-->--}%
%{--<asset:javascript src="projects-new.js"/>--}%
