            ...
            <div class="side-app">
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="page-header">
                        <div>
                            <h1 class="page-title">Lista dos Projetos</h1>
                        </div>
                        <div class="ms-auto pageheader-btn">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">Apps</li>
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Projetos</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Lista de Projetos</li>
                            </ol>
                        </div>
                    </div>
                    <!-- PAGE-HEADER END -->
                            ...
                            <div class="card">
                                <div class="card-body p-4">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h4 class="m-0">Todos Projetos</h4>
                                        <div class="btn-list">
                                            <a class="btn btn-outline-primary" href="projects.html">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-inner-icn" enable-background="new 0 0 24 24" viewBox="0 0 24 24"><path d="M21.5,13h-8.0005493C13.2234497,13.0001831,12.9998169,13.223999,13,13.5v8.0005493C13.0001831,21.7765503,13.223999,22.0001831,13.5,22h8.0006104C21.7765503,21.9998169,22.0001831,21.776001,22,21.5v-8.0006104C21.9998169,13.2234497,21.776001,12.9998169,21.5,13z M21,21h-7v-7h7V21z M10.5,2H2.4993896C2.2234497,2.0001831,1.9998169,2.223999,2,2.5v8.0005493C2.0001831,10.7765503,2.223999,11.0001831,2.5,11h8.0006104C10.7765503,10.9998169,11.0001831,10.776001,11,10.5V2.4993896C10.9998169,2.2234497,10.776001,1.9998169,10.5,2z M10,10H3V3h7V10z M10.5,13H2.4993896C2.2234497,13.0001831,1.9998169,13.223999,2,13.5v8.0005493C2.0001831,21.7765503,2.223999,22.0001831,2.5,22h8.0006104C10.7765503,21.9998169,11.0001831,21.776001,11,21.5v-8.0006104C10.9998169,13.2234497,10.776001,12.9998169,10.5,13z M10,21H3v-7h7V21z M21.5,2h-8.0005493C13.2234497,2.0001831,12.9998169,2.223999,13,2.5v8.0005493C13.0001831,10.7765503,13.223999,11.0001831,13.5,11h8.0006104C21.7765503,10.9998169,22.0001831,10.776001,22,10.5V2.4993896C21.9998169,2.2234497,21.776001,1.9998169,21.5,2z M21,10h-7V3h7V10z"/></svg>
                                            </a>
                                    ...
                                    <div class="table-responsive">
                                        <table id="project-table" class="table text-nowrap mb-0 table-bordered border-top border-bottom project-list-main">
                                            ...
                                            <tr>
                                                ...
                                                <th class="bg-transparent border-bottom-0">Titulo</th>
                                                <th class="bg-transparent border-bottom-0">Tarefa</th>
                                                <th class="bg-transparent border-bottom-0">Data Inicio</th>
                                                <th class="bg-transparent border-bottom-0">Membros</th>
                                                <th class="bg-transparent border-bottom-0">Data Fim</th>
                                                <th class="bg-transparent border-bottom-0">Progresso</th>
                                                <th class="bg-transparent border-bottom-0">Data de envio</th>
                                                <th class="bg-transparent border-bottom-0">Estado</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h6 class="mb-0 fs-14 fw-semibold">CMAM</h6>
                                                </td>
                                                <td class="text-muted fs-15 fw-semibold">28</td>
                                                <td class="text-muted fs-15 fw-semibold">10 Ago 2023</td>
                                                <td>
                                                    <div class="avatar-list avatar-list-stacked">
                                                        ...
                                                        <span class="avatar bradius bg-primary">+4</span>
                                                    </div>
                                                </td>
                                                <td class="text-muted fs-15 fw-semibold">11 Nov 2023</td>
                                                <td>
                                                ...
                                                <td>
                                                    <span class="mb-0 mt-1 badge rounded-pill text-warning bg-warning-transparent">Em espera</span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h6 class="mb-0 fs-14 fw-semibold">UGPK</h6>
                                                </td>
                                                <td class="text-muted fs-15 fw-semibold">3</td>
                                                <td class="text-muted fs-15 fw-semibold">21 Jan 2023</td>
                                                <td>
                                                    ...
                                                    <div class="avatar-list avatar-list-stacked">
                                                        ...
                                                        <span class="avatar bradius bg-primary">+2</span>
                                                    </div>
                                                </td>
                                                <td class="text-muted fs-15 fw-semibold">16 Apr 2023</td>
                                                <td>
                                                ...
                                                <td class="text-muted fs-15 fw-semibold">---</td>
                                                <td>
                                                    <span class="mb-0 mt-1 badge rounded-pill bg-info-transparent text-info">Em Progesso</span>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-stretch">
                                                        <a class="btn btn-sm btn-outline-secondary border me-2" data-bs-toggle="tooltip" data-bs-original-title="Delete">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h6 class="mb-0 fs-14 fw-semibold">GIT</h6>
                                                </td>
                                                <td class="text-muted fs-15 fw-semibold">1</td>
                                                <td class="text-muted fs-15 fw-semibold">21 Jul 2023</td>
                                                <td>
                                                    <div class="avatar-list avatar-list-stacked">
                                                        <span class="avatar bradius cover-image" data-bs-image-src= "/assets/images/users/9.jpg"></span>
                                                        <span class="avatar bradius cover-image" data-bs-image-src= "/assets/images/users/11.jpg"></span>
                                                ...
                                                <td class="text-muted fs-15 fw-semibold">21 Set 2023</td>
                                                <td>
                                                    <span class="mb-0 mt-1 badge rounded-pill bg-primary-transparent text-primary">Finalizado</span>
                                                </td>
...
<asset:javascript src="projects-edit.js"/>
</body>
</html>