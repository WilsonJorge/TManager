            ...
            <div class="app-sidebar">
                <div class="side-header">
                    <a class="header-brand1" href="#">
                        %{--<img src="../assets/images/intellica.jpg" class="header-brand-img desktop-logo" alt="logo">--}%
                            ...
                            <ul class="slide-menu">
                                ...
                                <li class="sub-slide">
                                    <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
                                            ...
                                            class="sub-angle fa fa-angle-right"></i></a>
                                    <ul class="sub-slide-menu">
                                        <li><a class="sub-slide-item" href="#">Lista de Tarefas</a></li>
                                        <li><a class="sub-slide-item" href="#">Editar Tarefa</a></li>
                                        <li><a class="sub-slide-item" href="#">Criar Tarefa</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
