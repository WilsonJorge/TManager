...
<head>
    ...
    <!-- TITLE -->
    <title>SGS – Sistemas de Gestao de Supervisao</title>
                ...
                <div class="d-flex">
                    ...
                    <a class="logo-horizontal " href="#">
                        %{--<img src="../assets/images/brand/logo.png" class="header-brand-img desktop-logo" alt="logo">--}%
                         <asset:image src="logo.png" class="header-brand-img desktop-logo" alt="logo"/>
                        %{--<img src="../assets/images/brand/logo-3.png" class="header-brand-img light-logo1"--}%
                             %{--alt="logo">--}%
                        <asset:image src="logo-3.png" class="header-brand-img light-logo1"/>
                    </a>
                    <!-- LOGO -->
                                    ...
                                    <div class="dropdown d-md-flex profile-1">
                                        <a href="#" data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
                                            <span>
                                                ...
                                                <asset:image src="6.jpg" alt="profile-user" class="avatar  profile-user brround cover-image"/>
                                            </span>
            ...
            <div class="app-sidebar">
                <div class="side-header">
                    <a class="header-brand1" href="#">
                        ...
                        <asset:image src="logo-1.png" class="header-brand-img toggle-logo" alt="logo"/>
                        %{--<img src="../assets/images/brand/logo-2.png" class="header-brand-img light-logo" alt="logo">--}%
                        <asset:image src="logo-2.png" class="header-brand-img light-logo"/>
                        %{--<img src="../assets/images/brand/logo-3.png" class="header-brand-img light-logo1" alt="logo">--}%
                        <asset:image src="logo-3.png" class="header-brand-img light-logo1" alt="logo"/>
                    </a><!-- LOGO -->
                </div>
...
<asset:javascript src="apexcharts.js"/>
...
<asset:javascript src="circle-progress.min.js"/>
...
<asset:javascript src="index1.js"/>

<!-- REPLY JS-->
%{--<script src="../assets/js/reply.js"></script>--}%
<asset:javascript src="reply.js"/>
